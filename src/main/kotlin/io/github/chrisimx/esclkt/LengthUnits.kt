...
value class Inches(val value: Double) : LengthUnit {
    ...
    override fun toThreeHundredthsOfInch() =
        ThreeHundredthsOfInch((this.value * THREE_HUNDREDTHS_INCHES_PER_INCH).toUInt())
}
...
value class Millimeters(val value: Double) : LengthUnit {
    ...
    override fun toThreeHundredthsOfInch() =
        ThreeHundredthsOfInch((this.value * THREE_HUNDREDTHS_INCHES_PER_MM).roundToInt().toUInt())
}
