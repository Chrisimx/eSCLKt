...
class ScanJob(
     ...
     * **/
    suspend fun retrieveNextPage(): ESCLRequestClient.ScannerNextPageResult = esclClient.retrieveNextPageForJob(jobUri)

    /** Gets the ScanImageInfo for the last retrieved page **/
    suspend fun getScanImageInfoForRetrievedPage(): ESCLRequestClient.RetrieveScanImageInfoResult = esclClient.retrieveScanImageInfoForJob(jobUri)
